...
Shader::Shader(std::filesystem::path vertexPath, std::filesystem::path fragmentPath) {
    ...
    if(!success) {
        ...
        std::cout << "ERROR::SHADER::VERTEX::COMPILATION::COMPILATION_FAILED (" << vertexPath.string() << ")" << std::endl;
    ...
    if(!success) {
        ...
        std::cout << "ERROR::SHADER::FRAGMENT::COMPILATION_FAILED (" << fragmentPath.string() << ")" << std::endl;
        std::cerr << infoLog << std::endl;
    }
